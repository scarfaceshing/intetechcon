...
?>
<center>
<form action="zupdate_farmer_process.php" method="post" enctype="multipart/form-data">
  <div id="container">
    <h2>UPDATE FARMER</h2>
    <input type="hidden" name="id" value="<?php echo $id ?>">
      ...
      <div>
        <input value="<?php echo $sto_street ?>" class="inputs" type="text" name="sto_street" required="" placeholder="Sitio/Street">
      </div>
  ...
  <input name="update_btn" class="btn btn-primary" id="save_btn" type="submit" value="UPDATE"/>
   <a class="btn btn-danger" href="ztblfarmer.php">CANCEL</a>
   </div>
</form>
</center>
