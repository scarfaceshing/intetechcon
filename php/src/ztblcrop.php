...
<div style="text-align: right;">
  <a class="btn btn-primary" href="ztblcrop_printview.php">Print View</a>
</div>      
<div class="col-md-12">
...
<form action="ztblcrop.php" method="post" style="margin-bottom: 50px">
  <a href="ztblcrop.php" class="Refresh">Refresh</a>
